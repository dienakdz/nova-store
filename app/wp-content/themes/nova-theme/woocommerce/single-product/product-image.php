...
$video_url         = function_exists( 'nova_get_product_video_url' ) ? nova_get_product_video_url( $product ) : '';
...
if ( $video_url ) {
	$wrapper_classes[] = 'nova-product-gallery-has-video';
}
?>
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
	<div class="woocommerce-product-gallery__wrapper">
		<?php if ( $video_url ) : ?>
			<div
				class="woocommerce-product-gallery__image nova-product-video-slide"
